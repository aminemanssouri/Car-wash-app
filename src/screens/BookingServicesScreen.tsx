      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {selectedServices.length > 0 && (
          <Card style={[styles.summaryCard, { backgroundColor: colors.surface, borderColor: colors.cardBorder }]}>
            <Text style={[styles.summaryTitle, { color: colors.textPrimary }]}>Selected Services</Text>
            ...
            <View style={[styles.totalContainer, { borderTopColor: colors.cardBorder }]}>
              <Text style={[styles.totalLabel, { color: colors.textPrimary }]}>Total Services:</Text>
          ...
          <View style={styles.infoList}>
            <View style={styles.infoItem}>
              ...
              <Text style={[styles.infoText, { color: colors.textSecondary }]}>
                All services include professional equipment and eco-friendly products
              </Text>
            </View>
            <View style={styles.infoItem}>
              <View style={[styles.infoBullet, { backgroundColor: colors.accent }]} />
              <Text style={[styles.infoText, { color: colors.textSecondary }]}>
                Service duration varies based on selected services (30-90 minutes)
              </Text>
            </View>
            <View style={styles.infoItem}>
              <View style={[styles.infoBullet, { backgroundColor: colors.accent }]} />
              <Text style={[styles.infoText, { color: colors.textSecondary }]}>
                You can modify your selection before final confirmation
              </Text>
            </View>
          </View>
        </Card>
