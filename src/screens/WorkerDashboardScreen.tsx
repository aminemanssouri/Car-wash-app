    ...
    <Card style={styles.bookingCard}>
      ...
      <View style={styles.bookingDetails}>
        ...
        <View style={styles.detailRow}>
          ...
          <Text style={[styles.detailText, { color: theme.textSecondary }]}>Customer contact info</Text>
        </View>
        ...
        {type === 'completed' && booking.workerRating && (
          <View style={styles.detailRow}>
            ...
            <Text style={[styles.detailText, { color: theme.textSecondary }]}>
              Rating: {booking.workerRating}/5 stars
            </Text>
          </View>
        )}
      </View>
        ...
        {loading && (
          <Card style={styles.bookingsCard}>
            <View style={styles.emptyState}>
              ...
              <Text style={[styles.emptyStateText, { color: theme.textPrimary }]}>Loading bookings...</Text>
            </View>
          </Card>
        )}
